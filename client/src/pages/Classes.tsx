...
import { Calendar, Users, ArrowLeft, Eye, ArrowRight } from "lucide-react";
          ...
          {isLoadingBirthYear ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {birthYearPlayers.map((player, index) => (
                <Link key={player.id} href={`/players/${encodeURIComponent((player as { player_id?: string }).player_id ?? String(player.id))}`}>
