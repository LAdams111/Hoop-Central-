          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="grid grid-cols-2 gap-2 md:gap-6">
                <StatsChart stats={player.stats} dataKey="pointsPerGame" label="Scoring & Efficiency" color="hsl(var(--primary))" />
                <StatsChart stats={player.stats} dataKey="assistsPerGame" label="Playmaking & Defense" color="hsl(var(--accent))" />
              </div>
            </div>
          </div>
